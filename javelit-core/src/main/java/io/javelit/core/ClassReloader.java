...
public class ClassReloader extends Reloader {
    ...
    public ClassReloader(AppConfig config) {
        checkArgument(config.buildSystem == BuildSystem.RUNTIME, "Class reloader only supports RUNTIME build systems.");
        checkArgument(config.appClass != null);
        this.appClassName = config.appClass.getName();
    }
