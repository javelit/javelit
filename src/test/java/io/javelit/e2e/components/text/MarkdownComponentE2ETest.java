  ...
  void testMarkdownVariations(TestInfo testInfo) {
    ...
    PlaywrightUtils.runInBrowser(testInfo, app, page -> {
      ...
      assertThat(page
                     ...
                     .nth(3)
                     .locator("code",
                              new Locator.LocatorOptions().setHasText("inline code"))).isVisible(WAIT_1_SEC_MAX);
      assertThat(page
                     .locator("jt-markdown")
                     .nth(3)
                     .locator("code",
                              new Locator.LocatorOptions().setHasText("System.out.println(\"Hello World\");"))).isVisible(
          WAIT_1_SEC_MAX);
