...
public class SelectBoxComponentE2ETest {
  ...
  void testBasicSelectBoxWithStrings(TestInfo testInfo) {
    ...
    PlaywrightUtils.runInBrowser(testInfo, app, page -> {
      ...
      // Select Green option
      page
          .locator("jt-selectbox .selectbox-option", new Page.LocatorOptions().setHasText("Green"))
  ...
  void testSelectBoxWithSecondValueSelected(TestInfo testInfo) {
    ...
    PlaywrightUtils.runInBrowser(testInfo, app, page -> {
      ...
      // Select Large option
      page
          .locator("jt-selectbox .selectbox-option", new Page.LocatorOptions().setHasText("Large"))
          .click(WAIT_1_SEC_MAX_CLICK);
      // Verify selection changed to Large
  ...
  void testSelectBoxWithNullIndex(TestInfo testInfo) {
    ...
    PlaywrightUtils.runInBrowser(testInfo, app, page -> {
      ...
      // Select Option B
      page
          .locator("jt-selectbox .selectbox-option", new Page.LocatorOptions().setHasText("Option B"))
          .click(WAIT_1_SEC_MAX_CLICK);
      // Verify selection changed to Option B
  ...
  void testSelectBoxWithObjectsAndFormatFunction(TestInfo testInfo) {
    ...
    PlaywrightUtils.runInBrowser(testInfo, app, page -> {
      ...
      // Click to open dropdown and verify formatted options
      page.locator("jt-selectbox .selectbox-control").click(WAIT_1_SEC_MAX_CLICK);
      assertThat(page.locator("jt-selectbox .selectbox-option",
                              new Page.LocatorOptions().setHasText("Alice (25 years)"))).isVisible(WAIT_1_SEC_MAX);
      assertThat(page.locator("jt-selectbox .selectbox-option",
                              new Page.LocatorOptions().setHasText("Bob (30 years)"))).isVisible(WAIT_1_SEC_MAX);

      // Select Bob option
      page
          .locator("jt-selectbox .selectbox-option", new Page.LocatorOptions().setHasText("Bob (30 years)"))
          .click(WAIT_1_SEC_MAX_CLICK);
      // Verify selection changed to Bob
  ...
  void testSelectBoxWithAcceptNewOptionsAndExistingList(TestInfo testInfo) {
    ...
    PlaywrightUtils.runInBrowser(testInfo, app, page -> {
      ...
      page.locator("jt-selectbox .selectbox-control").click(WAIT_1_SEC_MAX_CLICK);
      page
          .locator("jt-selectbox .selectbox-option", new Page.LocatorOptions().setHasText("Python"))
          .click(WAIT_1_SEC_MAX_CLICK);
