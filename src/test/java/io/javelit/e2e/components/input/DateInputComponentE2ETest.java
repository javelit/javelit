...
public class DateInputComponentE2ETest {
  ...
  void testBasicDateInput(TestInfo testInfo) {
    ...
    PlaywrightUtils.runInBrowser(testInfo, app, page -> {
      ...
      // Select a different day (day 15 of current month - July)
      page
          .locator("jt-date-input .calendar-day:not(.other-month)", new Page.LocatorOptions().setHasText("15"))
          .first()
  ...
  void testDateInputWithDefaultValue(TestInfo testInfo) {
    ...
    PlaywrightUtils.runInBrowser(testInfo, app, page -> {
      ...
      // Select day 20
      page
          .locator("jt-date-input .calendar-day:not(.other-month)", new Page.LocatorOptions().setHasText("20"))
          .first()
          .click(WAIT_1_SEC_MAX_CLICK);
  ...
  void testDateInputWithMinMaxConstraints(TestInfo testInfo) {
    ...
    PlaywrightUtils.runInBrowser(testInfo, app, page -> {
      ...
      final Locator previousDayButton = page
          .locator("jt-date-input .calendar-day:not(.other-month)",
                   new Page.LocatorOptions().setHasText(String.valueOf(previousDay)))
          .first();
      ...
      page
          .locator("jt-date-input .calendar-day:not(.other-month)",
                   new Page.LocatorOptions().setHasText(String.valueOf(futureDate.getDayOfMonth())))
          .first()
          .click(WAIT_1_SEC_MAX_CLICK);
