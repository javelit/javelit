...
public class RadioComponentE2ETest {
  ...
  void testRadioWithObjectsAndFormatFunction(TestInfo testInfo) {
    ...
    PlaywrightUtils.runInBrowser(testInfo, app, page -> {
      ...
      assertThat(page.locator("jt-radio")).isVisible(WAIT_1_SEC_MAX);
      // Verify formatted options are displayed
      assertThat(page.locator("jt-radio .radio-option-label",
  ...
  void testRadioWithCaptions(TestInfo testInfo) {
    ...
    PlaywrightUtils.runInBrowser(testInfo, app, page -> {
      ...
      assertThat(page.locator("jt-radio")).isVisible(WAIT_1_SEC_MAX);
      // Verify captions are displayed
      assertThat(page.locator("jt-radio .radio-option:first-child .caption")).containsText("$0/month",
                                                                                           WAIT_1_SEC_MAX_TEXT_C);
      assertThat(page.locator("jt-radio .radio-option:nth-child(2) .caption")).containsText("$10/month",
                                                                                            WAIT_1_SEC_MAX_TEXT_C);
      assertThat(page.locator("jt-radio .radio-option:nth-child(3) .caption")).containsText("$50/month",
                                                                                            WAIT_1_SEC_MAX_TEXT_C);
      // First option (Basic) is selected by default
