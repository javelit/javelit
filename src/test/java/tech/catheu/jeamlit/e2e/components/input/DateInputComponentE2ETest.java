...
import static tech.catheu.jeamlit.e2e.helpers.PlaywrightUtils.WAIT_1_SEC_MAX_CLASS;
import static tech.catheu.jeamlit.e2e.helpers.PlaywrightUtils.WAIT_1_SEC_MAX_CLICK;
...
public class DateInputComponentE2ETest {
    ...
    void testBasicDateInput() {
        ...
        PlaywrightUtils.runInSharedBrowser(app, page -> {
            ...
            assertThat(page.locator("jt-date-input")).isVisible(WAIT_1_SEC_MAX);
