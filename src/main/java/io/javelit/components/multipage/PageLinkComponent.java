 ...
 */
package io.javelit.components.multipage;
...
import io.javelit.core.NavigationComponent;
...
public final class PageLinkComponent extends JtComponent<JtComponent.NONE> {
  ...
  public static class Builder extends JtComponentBuilder<NONE, PageLinkComponent, Builder> {
    ...
    /**
     * The text to display for the link. Markdown is supported, see {@link io.javelit.core.Jt#markdown(String)} for more details.
     */
