 ...
 */
package io.javelit.components.chart;
...
public final class EchartsComponent extends JtComponent<JtComponent.NONE> {
  ...
  public static class Builder extends JtComponentBuilder<JtComponent.NONE, EchartsComponent, Builder> {
     ...
     * The geoJson URI should point to valid geoJson file. If you want Javelit to host the file, see <a href="/get-started/fundamentals/additional-features#static-file-serving" target="_blank">static file serving</a>.
     */
     ...
     * A GEO map to register.
     * You can register multiple maps by calling this method multiple times.
     * The geoJson URI should point to valid geoJson file. If you want Javelit to host the file, see [static file serving](/get-started/fundamentals/additional-features#static-file-serving).
     */
    public Builder withMap(final @Nonnull String mapName,
                           final @Nonnull URI geoJson,
                           final Map<String, SpecialAreaConfig> specialAreas) {
