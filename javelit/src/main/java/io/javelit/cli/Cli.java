...
@Command(name = "javelit", mixinStandardHelpOptions = true,
...
public class Cli implements Callable<Integer> {
    ...
    static class RunCommand implements Callable<Integer> {
        ...
        @Parameters(index = "0", description = "The Javelit app Java file to run")
        ...
        public Integer call() throws Exception {
            ...
            logger.info("Starting Javelit on file {}", javaFilePath.toAbsolutePath());
    ...
    static class HelloWorldCommand implements Callable<Integer> {
        ...
        public Integer call() throws Exception {
            ...
            if (Files.exists(helloWorldFile)) {
                ...
                logger.info("You can run it with: javelit run --port {} HelloWorld.java", port);
                return 1;
            }
