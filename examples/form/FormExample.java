...
public class FormExample {
    ...
    public static void main(String[] args) {
        ...
        var cols = Jt.columns("cols", 2).use();
        Jt.empty("spacer").height(15).border(false).use(cols.col(0));
        ...
        Jt.empty("spacer2").height(35).border(false).use(cols.col(0));
        ...
        var formContainer = Jt.form("my_form").use(cols.col(1));
