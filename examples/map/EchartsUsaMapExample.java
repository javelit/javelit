...
public class EchartsUsaMapExample {
    ...
    public static void main(String[] args) {
        ...
        Map<String, EchartsComponent.SpecialAreaConfig> specialAreas = Map.of(
                ...
                "Puerto Rico", new EchartsComponent.SpecialAreaConfig(-76, 26, 2)
        );

        // Create the population data
        Object[] populationData = new Object[]{
                Map.of("name", "Alabama", "value", 4822023),
                Map.of("name", "Alaska", "value", 731449),
                Map.of("name", "Arizona", "value", 6553255),
                Map.of("name", "Arkansas", "value", 2949131),
                Map.of("name", "California", "value", 38041430),
                Map.of("name", "Colorado", "value", 5187582),
                Map.of("name", "Connecticut", "value", 3590347),
                Map.of("name", "Delaware", "value", 917092),
                Map.of("name", "District of Columbia", "value", 632323),
                Map.of("name", "Florida", "value", 19317568),
                Map.of("name", "Georgia", "value", 9919945),
                Map.of("name", "Hawaii", "value", 1392313),
                Map.of("name", "Idaho", "value", 1595728),
                Map.of("name", "Illinois", "value", 12875255),
                Map.of("name", "Indiana", "value", 6537334),
                Map.of("name", "Iowa", "value", 3074186),
                Map.of("name", "Kansas", "value", 2885905),
                Map.of("name", "Kentucky", "value", 4380415),
                Map.of("name", "Louisiana", "value", 4601893),
                Map.of("name", "Maine", "value", 1329192),
                Map.of("name", "Maryland", "value", 5884563),
                Map.of("name", "Massachusetts", "value", 6646144),
                Map.of("name", "Michigan", "value", 9883360),
                Map.of("name", "Minnesota", "value", 5379139),
                Map.of("name", "Mississippi", "value", 2984926),
                Map.of("name", "Missouri", "value", 6021988),
                Map.of("name", "Montana", "value", 1005141),
                Map.of("name", "Nebraska", "value", 1855525),
                Map.of("name", "Nevada", "value", 2758931),
                Map.of("name", "New Hampshire", "value", 1320718),
                Map.of("name", "New Jersey", "value", 8864590),
                Map.of("name", "New Mexico", "value", 2085538),
                Map.of("name", "New York", "value", 19570261),
                Map.of("name", "North Carolina", "value", 9752073),
                Map.of("name", "North Dakota", "value", 699628),
                Map.of("name", "Ohio", "value", 11544225),
                Map.of("name", "Oklahoma", "value", 3814820),
                Map.of("name", "Oregon", "value", 3899353),
                Map.of("name", "Pennsylvania", "value", 12763536),
                Map.of("name", "Rhode Island", "value", 1050292),
                Map.of("name", "South Carolina", "value", 4723723),
                Map.of("name", "South Dakota", "value", 833354),
                Map.of("name", "Tennessee", "value", 6456243),
                Map.of("name", "Texas", "value", 26059203),
                Map.of("name", "Utah", "value", 2855287),
                Map.of("name", "Vermont", "value", 626011),
                Map.of("name", "Virginia", "value", 8185867),
                Map.of("name", "Washington", "value", 6897012),
                Map.of("name", "West Virginia", "value", 1855413),
                Map.of("name", "Wisconsin", "value", 5726398),
                Map.of("name", "Wyoming", "value", 576412),
                Map.of("name", "Puerto Rico", "value", 3667084)
        };
        ...
        Option option = new Option()
                ...
                .setVisualMap(new ContinousVisualMap()
                                      ...
                                      .setMin(500000)
                                      .setMax(38000000)
                                      .setColor(new String[]{"#a50026", "#d73027", "#f46d43", "#fdae61", "#fee090",
                ...
                .setToolbox(new Toolbox()
                                    ...
                                    .setTop("top")
                                    .setFeature(Map.of(
                                            "dataView", new ToolboxDataViewFeature().setReadOnly(false),
                                            "restore", new ToolboxRestoreFeature(),
                                            "saveAsImage", new ToolboxSaveAsImageFeature()
                                    )))
        ...
        Jt.echarts(option)
          .withMap("USA",
                   URI.create("/app/static/usa.json"),
                   specialAreas)
          .height(600)
          .use();
