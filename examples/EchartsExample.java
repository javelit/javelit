...
public class EchartsExample {
    public static void main(String[] args) throws Exception {
        ...
        Jt.text("💡 **Tip**: ECharts provides extensive customization options. "
                 + "Check the [ECharts Java documentation](https://echarts.icepear.org) for more examples and configuration options.").use();
