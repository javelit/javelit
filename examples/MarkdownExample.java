...
//DEPS io.javelit:javelit:0.54.0
...
public class MarkdownExample {
    public static void main(String[] args) {
        ...
        Jt.markdown("This markdown content uses **content** width - it takes only the space it needs.").width("content").use();
        
        Jt.markdown("### Fixed Width (400px)").use();
        Jt.markdown("This markdown content is constrained to exactly **400 pixels** wide, which is useful for creating consistent layouts.").width(400).use();
        
        Jt.markdown("### Stretch Width (Default)").use();
        Jt.markdown("This markdown content uses **stretch** width - it expands to fill the available container space, which is the default behavior.").use();
        ...
        Jt.markdown("---").use();
        Jt.markdown("*This demo showcases all the styling features of the MarkdownComponent. Notice the consistent spacing, typography, and visual hierarchy throughout all examples.*").use();
    }
}
